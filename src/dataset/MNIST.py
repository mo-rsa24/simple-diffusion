...
def get_mnist_loaders(cfg: Box, number: int = None):
    ...
    if cfg.sanity.enabled:
        ...
        dataset = tiny_subset(dataset, cfg.sanity.num_examples)
        val_dataset = tiny_subset(val_dataset, cfg.sanity.num_examples)
